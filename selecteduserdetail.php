...
<head>
    ...
    body{
          background-image:url('coin_image.jpg');
...
?>
	...
	<div class="container">
        <h2 class="text-center pt-4"style="font-family: 'Courier New', Courier, monospace;font-weight: bold;font-size: 35px">TRANSACTION</h2>
            ...
            <br>
        <div>
            <table class="table table-striped table-condensed table-bordered"style="background-color:#F4F1E6">
                <tr>
        ...
        <label><h3 style="font-family: 'Courier New', Courier, monospace;font-weight: bold;font-size: 35px">TRANSFER TO:</h3></label>
        ...
        <select name="to" class="input-field" required>
            ...
            <button class="btn" name="submit" type="submit" id="myBtn" style="font-family: 'Courier New', Courier, monospace;font-weight: bold;font-size: 20px;"><B>TRANSFER</B></button><br><br>
